    ...
    def get_jobs(start, end, webdriver_location, location='Pune', query=''):
        ...
        for i in range(start, end):
            ...
            for job in driver.find_elements_by_class_name('result'):
                ...
                data = Row(dict(Title=str(title), Location=str(location), Company=str(company), Salary=str(salary), Sponsored=str(sponsored), Description=str(job_desc), Time=str(time)))
